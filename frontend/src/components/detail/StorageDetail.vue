  ...
  <div class="space-y-6">
    ...
    <div class="card p-5">
      ...
      <div v-else class="space-y-4">
        <div v-for="pool in metrics.pools" :key="pool.name" class="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
          ...
          <ProgressBar :value="pool.percent" :max="100" />
        </div>
      </div>
    </div>
      ...
      <div class="divide-y divide-slate-200 dark:divide-slate-700">
        ...
        >
          <div class="flex items-center justify-between">
            <div>
              <div class="font-medium text-slate-900 dark:text-white">{{ disk.name }}</div>
